...
UtilityAIBTNodes::Status UtilityAIBTCooldownUsec::get_cooldown_return_value() const {
	return _cooldown_return_value;
}

// Handling methods.

UtilityAIBTNodes::Status UtilityAIBTCooldownUsec::tick(Variant blackboard, float delta) {
